...
export const TrendingUp2 = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-purple-600 icon icon-tabler icons-tabler-outline icon-tabler-trending-up"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      <path d="M3 17l6 -6l4 4l8 -8" />
      <path d="M14 7l7 0l0 7" />
...
export const Pig = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-green-600 icon icon-tabler icons-tabler-outline icon-tabler-pig"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      <path d="M15 11v.01" />
...
export const Wallet = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-blue-600 icon icon-tabler icons-tabler-outline icon-tabler-wallet"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export const ReturnArrow = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="mx-4 my-5 icon icon-tabler icons-tabler-outline icon-tabler-arrow-narrow-left md:my-10 md:mx-8"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      <path d="M5 12l14 0" />
      <path d="M5 12l4 4" />
